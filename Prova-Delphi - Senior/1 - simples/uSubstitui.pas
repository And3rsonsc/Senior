...
begin
  ...
  i := 1;
  j := 1;
  str := aStr + '\'; // Para ter um sinalizador de final de string foi utilizado o \, aVelho e aNovo não se utilizam, pois o método foi criado levando em consideração que seriam sempre uma palavra só.
  repeat
