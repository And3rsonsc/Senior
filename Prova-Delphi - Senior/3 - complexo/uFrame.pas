...
procedure TFrame.novoTamanho(vAltura, vLargura: integer; pAltura,  //função de alteração do tamanho do frame externo
  pLargura: integer);
  var
...
procedure TFrame.Redimensionar(vAltura, vLargura: integer; pAltura,    //valor de aumento do frame interno e proporsão de aumento em %
  pLargura: real);
begin
