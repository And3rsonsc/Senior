...
type
  ...
  TMemos = class(TComponente) //precisei alterar o nome do tipo para não dar erro na hora de criar o objeto
  public
...
procedure TMemos.Redimensionar(vAltura, vLargura: integer; pAltura,     //valor de aumento do frame e proporsão de aumento em %
  pLargura: real);
begin
